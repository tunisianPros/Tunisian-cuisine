...
window.open(`${recipeName}.html`)
}

var recipes = [
    {
        name: "Mloukhia",
        ingredient: ['1 packet of mloukhia (100g)','neutral cooking oil','3-4 bay leaves','1.25 lamb shoulder chop (bone-in)','2 tablespoons tabil', '1 tsp caraway','1-2 tbsp homemade harissa (harissa arabi) and/or 1 tbsp tomato paste', '3 garlic cloves'],
   ...
   {
        name:"Lablebi",
        ingredient:['2 cups whole, dry chickpeas','3.5 -4 cups water','1 tsp cumin','1 tsp salt','½ tsp black pepper','2 whole eggs poached','Canned tuna','Harissa and/or crushed red pepper flakes','Olive oil','Stale bread or fresh kesra torn into small pieces','Accompaniments:Tuna, Olives, Egg, Harissa, Capers, Pickled vegetables'],
    ...
    {
        name:"omekHouria",
        ingredient:['5-6 large carrots','2 tbs Olive oil','Salt','Black pepper','1 tsp white vinegar','Handful of fresh chopped parsley','Some dried black olives to garnish'],
    ...
    {
        name:"slataMechouia",
        ingredient:['4 whole onions','5 whole tomatoes','one whole garlic bulb, or several whole garlic cloves with the peel','4-5 whole green Anaheim pepper','1/2 tsp salt','1/4 tsp black pepper','1-2-3 tbs Olive Oil','Olives','Tuna','Hard boiled eggs'],
    ...
    {
        name :'citronade',
        ingredient:['9 lemons','1 cup plus 2 tablespoons of sugar','4-4.5 cups water','1.5 teaspoons orange blossom water','Optional:sprigs of mint'],
...
var recipeName = ['tajine', 'brik', 'omekHouria', 'slataMechouia', 'mloukhia', 'couscous', 'lablebi', 'ojja', 'mintTea', 'citronade', 'baklawa', 'cornesGazelle'];
    ...
    var recipeButtons = document.querySelectorAll('.button')
